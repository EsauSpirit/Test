...
public class Vista extends javax.swing.JFrame implements ActionListener, TransferenciaListener{
    ...
    private void init() throws IOException
    {
        ...
        //System.out.println("prueba ip"+ip);
        
        pruebaip = InetAddress.getLocalHost();
        hostname = pruebaip.getHostName();
        System.out.println("Your current IP address : " + pruebaip);
        //NetworkInterface ni = NetworkInterface.getByName("wlp2s0");
        NetworkInterface ni = NetworkInterface.getByName("enp2s0");
        
        System.out.println("THIS IS ni"+ni);
       //ip ="10.0.0.3";
       //ip ="192.168.1.68";
       ...
       InetAddress iaddress;
        ...
        System.out.println("el valor de ip es"+ ip);
        ip = ip.substring(1,13);
        System.out.println("The new value of S is "+ ip);
       
       /*while(inetAddresses.hasMoreElements()) {
            InetAddress ia = inetAddresses.nextElement();
            if(!ia.isLinkLocalAddress()) {
                System.out.println("La IP de mi equipo es: " + ia.getHostAddress());
            }
        }/*
       ...
       //NetworkInterface nif = NetworkInterface.getByInetAddress(InetAddress.getLocalHost());
        ...
        { 
            ...
            System.out.println("This is ee"+ee);
